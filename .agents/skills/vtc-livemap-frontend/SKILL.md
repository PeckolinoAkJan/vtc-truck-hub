...
3. Datenbezug: Die Karte lädt `GET /api/v1/live` als Snapshot und aktualisiert ihn per robustem HTTP-Polling im bestehenden Drei-Sekunden-Intervall. Kein SSE-/WebSocket-Fallback erfinden.
